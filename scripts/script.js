document.addEventListener('DOMContentLoaded', function () {
  document.getElementById('alternatingTextForm').addEventListener('submit', function (e) {
    ...
    // Convert input text to its script equivalent using toUnicodeVariant
    let scriptText = toUnicodeVariant(inputText, 'script');

    // Set the script text as the value of the output element
    const outputElement = document.getElementById('alternatingTextOutput');
    outputElement.textContent = scriptText; // Use textContent to set text
